  ...
  <v-card>
    ...
    <v-card-text>
        <v-form>
            ...
            <v-card-item><v-select :items="observedPropertyOptions" item-title="name" item-value="id" label="observed_property" v-model="observerCharacteristics.observed_parameter" :hint="observedPropertyOptionsHint" return-object persistent-hint></v-select></v-card-item>
...
export default defineComponent({
  ...
  setup() {
    ...
    const observedPropertyOptionsHint = computed(() => {
      if( observerCharacteristics.value.observed_parameter !== null ){
        if ( 'description' in observerCharacteristics.value.observed_parameter ){
          return observerCharacteristics.value.observed_parameter.description;
        }else{
          return "";
        }
      }else{
