  ...
  <v-card>
    ...
    <v-card-text>
        <v-form>
            ...
            <v-card-item><v-text-field label="elevation" v-model="observation.elevation" type="number" hint="Elevation of observation above mean sea level" persistent-hint></v-text-field></v-card-item>
            ...
            <v-card-item><v-select :items="featureOptions" item-title="name" item-value="id" label="feature" v-model="observation.feature_of_interest" :hint="featureOptionsHint" return-object persistent-hint></v-select></v-card-item>
...
export default defineComponent({
  ...
  setup() {
    ...
    const featureOptionsHint = computed(() => {
      if( observation.value.feature_of_interest !== null ){
        if ( 'description' in observation.value.feature_of_interest ){
          return observation.value.feature_of_interest.description;
        }else{
          return "";
        }
      }else{
